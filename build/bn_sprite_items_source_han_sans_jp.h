...
//======================================================================
//
//	source_han_sans_jp_bn_gfx, 16x1568@4, 
//	+ palette 16 entries, not compressed
//	+ 392 tiles Metatiled by 2x2 not compressed
//	Total size: 32 + 12544 = 12576
//
//	Time-stamp: 2025-02-21, 16:27:54
...
#define source_han_sans_jp_bn_gfxTilesLen 12544
extern const bn::tile source_han_sans_jp_bn_gfxTiles[392];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item source_han_sans_jp(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(source_han_sans_jp_bn_gfxTiles, 392), bpp_mode::BPP_4, compression_type::NONE, 98), 
